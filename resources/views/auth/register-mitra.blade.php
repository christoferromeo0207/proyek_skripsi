...
@section('content')
  <div class="flex items-center justify-center py-12">
    <div class="w-full max-w-md p-8 bg-orange-100 rounded-lg">
      ...
      <form action="{{ route('register.mitra') }}" method="POST" class="space-y-4">
        @csrf
        ...
        <div>
          ...
          <input name="name" type="text" value="{{ old('name') }}" required
                 class="mt-1 block w-full px-3 py-2 border border-orange-300 rounded focus:ring-orange-200"
        ...
        <button type="submit"
                class="w-full py-2 px-4 bg-orange-500 hover:bg-orange-600 text-white rounded-lg">
          Register Mitra
        </button>
      </form>
